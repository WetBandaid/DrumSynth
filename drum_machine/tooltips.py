CONTROL_TOOLTIPS = {
    ...
    "kit_pack": "Choose a factory kit pack to apply across every track.",
    "apply_kit_pack": "Apply the selected factory kit pack while keeping patterns and song scenes.",
